"""
scheduler.py — enforces the child's work-time window using APScheduler.
...
def build(cfg: ChildConfig) -> AsyncIOScheduler:
...
def is_within_window(cfg: ChildConfig) -> bool:
